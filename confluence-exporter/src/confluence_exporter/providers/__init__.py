...
from confluence_exporter.models import ImageDescriberConfig

# Fully-qualified class paths for each supported provider.
_PROVIDERS: dict[str, str] = {
    "anthropic": (
        "confluence_exporter.providers.anthropic_describer"
        ".AnthropicImageDescriber"
    ),
    "openai": (
        "confluence_exporter.providers.openai_describer"
        ".OpenAIImageDescriber"
    ),
    "bedrock": (
        "confluence_exporter.providers.bedrock_describer"
