...
Feature: confluence-exporter, Property 5: Unknown macros render as plain text with identifying comment
"""
...
from confluence_exporter.models import MacroNode, PageMetadata
