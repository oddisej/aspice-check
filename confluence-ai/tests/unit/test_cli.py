...
from confluence_ai.cli import main, sanitize_title
...
class TestNoAiFlag:
    ...
    @patch("confluence_ai.cli.ConfluenceClient")
    @patch("confluence_ai.cli.create_describer")
...
class TestVerboseFlag:
    ...
    def test_verbose_sets_debug_logging(
        ...
        assert result.exit_code == 0, f"CLI failed: {result.output}"
        pkg_logger = logging.getLogger("confluence_ai")
...
class TestExitCodes:
    ...
    @patch("confluence_ai.cli.URLParser")
