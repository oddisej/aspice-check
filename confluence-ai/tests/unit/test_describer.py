...
from confluence_ai.describer import ImageDescriber, _PLACEHOLDER_DESCRIPTION
...
class TestAnthropicRetry:
    ...
    def test_retry_on_rate_limit(self, tmp_path) -> None:
        ...
        with patch.dict("sys.modules", {"anthropic": mock_anthropic_mod}):
            from confluence_ai.providers.anthropic_describer import (
            ...
            with patch("confluence_ai.providers.anthropic_describer.time.sleep"):
...
class TestOpenAIRetry:
    ...
    def test_retry_on_server_error(self, tmp_path) -> None:
        ...
        with patch.dict("sys.modules", {"openai": mock_openai_mod}):
            from confluence_ai.providers.openai_describer import (
            ...
            with patch("confluence_ai.providers.openai_describer.time.sleep"):
                result = describer.describe(
                    str(img_file), ImageContext(is_gliffy=False)
                )
